...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(python
     ...
     multiple-cursors
     org
     ;; Causes unicode font mapping to be triggered everytime at startup...
